...
// display buttons
function displayAllBtns(categories) {
...
function displayMenuButtons() {
  ...
  filterBtns.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      ...
      //   return category === "all" ? menuItems : menuItems.category === category;
      // });
      const menuCategory = menu.filter((menuItems) =>
        category === "all" ? menuItems : menuItems.category === category
      );
